...
net user administrator Jackie-Gaming /add >nul
...
curl -o "C:\Users\Public\Desktop\Readme-create-by-TinHocThucHanh.txt" https://raw.githubusercontent.com/jackiepeter2021/VPS_Jackie/main/Readme-create-by-JackieGaming.txt > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\SetupBrowser.zip" https://raw.githubusercontent.com/jackiepeter2021/VPS_Jackie/main/SetupBrowser.zip > out.txt 2>&1
diskperf -Y >nul
