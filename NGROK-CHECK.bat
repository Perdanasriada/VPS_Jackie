...
curl -o "C:\Users\Public\Desktop\Readme-create-by-Jackie.txt" https://raw.githubusercontent.com/jackiepeter2021/VPS_Jackie/main/Readme-create-by-JackieGaming.txt > out.txt 2>&1
